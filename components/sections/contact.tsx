...
const courseOptions = ["Salsa Cubana", "Bachata", "Kizomba", "Caraibico Base", "Caraibico Intermedio", "Caraibico Avanzato", "Corso Coppia", "Corso Donna", "Corso Uomo", "Lezione Privata"]
      ...
      <div className="relative overflow-hidden py-24">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-16 px-4 text-left lg:px-0 lg:text-center">
            ...
            <p className="max-w-none text-lg text-pretty text-foreground lg:mx-auto lg:max-w-2xl">Scrivici e ti aiutiamo a scegliere il corso più adatto a te. Ti rispondiamo con orari, disponibilità e prossimi passi per iniziare a ballare.</p>
          </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-4" id="sedi"><MapPin className="mt-1 h-6 w-6 flex-shrink-0 text-primary" /><div><div className="mb-2 font-semibold text-foreground">Indirizzo</div><div className="text-foreground">Latin Lovers Dance Montoro<br />Montoro, Italy</div></div></div>
      ...
      <div className="relative z-10 bg-[#050505] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="aspect-video w-full overflow-hidden rounded-sm border border-border md:aspect-[21/9]">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3620.3934705999955!2d14.766568099999999!3d40.684320899999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x133bc3a883db2b89%3A0x4a8dcd259424ddb1!2sLatin%20Lovers%20Dance%20Montoro!5e1!3m2!1sen!2sit!4v1781868209098!5m2!1sen!2sit" width="100%" height="100%" style={{ border: 0 }} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
          </div>
        </div>
      </div>
    </section>
